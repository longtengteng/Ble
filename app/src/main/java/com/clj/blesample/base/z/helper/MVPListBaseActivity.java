 ...
 * @Date 2018/4/13 0013 14:45
 * @CreateBy Android Studio
 * @ModifiedBy
 */


public abstract class MVPListBaseActivity<V extends BaseView, T extends BasePresenterImpl<V>, L> extends AppCompatActivity implements BaseView, BaseQuickAdapter.OnItemClickListener {
    public T mPresenter;
    ...
    /**
     * must call bindlist() first"
     *
     * @return null if not bindlist
     */
     ...
     * @param t
     */
    public abstract void convertView(RecyclerView recyclerView, BaseViewHolder helper, L t);
