...
import android.content.Context; import android.content.res.TypedArray; import android.graphics.Canvas; import android.graphics.Paint; import android.graphics.RectF; import android.util.AttributeSet; import android.view.View;
...
public class CompletedView extends View {
    ...
    private void initAttrs(Context context, AttributeSet attrs) {
        ...
        mRingRadius = mRadius + mStrokeWidth / 2; } //初始化画笔
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (mProgress > 0 ) {
            ...
            canvas.drawText(txt, mXCenter - mTxtWidth / 2, mYCenter + mTxtHeight / 4, mTextPaint); } } //设置进度
